        ...
        <main
          className={
            type === PUBLIC_LIST_TYPES.designs.type
              ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center gap-20 p-4 w-full mb-20 max-w-6xl mx-auto justify-center items-center"
