...
export const CTA = ({
  ...
  const wrapper =
    "text-sm md:text-base font-semibold relative block group overflow-hidden hover:shadow-2xl transition-all";
  ...
  const style = `absolute left-0 top-full group-hover:top-0 group-hover:scale-100 scale-0 origin-center transition-all w-full h-full rounded-full ease-linear ${
