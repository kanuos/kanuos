...
export const PageLink = ({
  ...
  const cls = `inline-block py-0.5 content--sub relative after:absolute after:h-[1.5px] hover:after:w-full after:left-0 after:-bottom-1 after:bg-secondary after:rounded-full font-semibold after:transition-all ${
    special
