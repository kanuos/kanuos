export const StyledHeader = ({
  ...
  const commonCls = `uppercase absolute text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black bg-contain leading-[0.75] md:leading-[0.75] xl:leading-[0.75] w-min max-w-xs sm:max-w-sm md:max-w-lg break-words text-right block box-decoration-clone`;
