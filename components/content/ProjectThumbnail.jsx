        ...
        <article 
            ...
            <ul className="text-sm mt-4 group-even:text-right group-odd:text-left">
                ...
                <Link href={projectURL}>
                    <a className={"py-1.5 px-6 block z-10 peer  transition-all hover:shadow-xl border-2 " + (isDarkMode ? "border-secondary hover:text-dark text-secondary font-semibold" : "hover:text-light border-dark")}>
