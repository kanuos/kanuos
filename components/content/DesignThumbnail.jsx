      ...
      <div className="bg-dark md:bg-light w-full h-full min-h-[22rem] max-w-xs">
        <figure className="relative w-full h-full min-h-[22rem] max-w-xs">
          <Image
            ...
            className="h-full w-full object-cover filter brightness-50 grayscale md:grayscale-0 group-hover:blur-sm md:group-hover:blur-none md:brightness-100 group-hover:brightness-100 opacity-60 md:opacity-100 transition-all group-hover:h-3/5 group-hover:scale-125"
          />
        </figure>
      </div>

      <section className="bottom-0 left-0 w-full h-full md:h-3/5 absolute z-10 bg-transparent group-hover:bg-light group-hover:bg-opacity-70 md:group-hover:bg-opacity-100 md:bg-light bg-opacity-90 md:bg-opacity-100 translate-y-0 md:translate-y-full md:group-hover:translate-y-0 md:opacity-0 md:group-hover:opacity-100 md:transition-all md:transform-gpu md:duration-300 md:delay-200 flex flex-col items-center justify-center gap-y-10">
        <h3 className="font-semibold text-lg text-light group-hover:text-dark md:text-dark">
          {data.title}
        </h3>
