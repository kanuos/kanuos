...
export const DesignThumbnail = ({ data, adminMode, center, index=0 }) => {
  ...
  return (
    <motion.article
      initial={{ scale : .5, rotate : (index % 2 === 0  ? -3 : 3) }}
      whileInView={{ rotate : 0, scale: 1.05, transition : { type : 'spring', stiffness : 400 }}}
      className={
        (center
          ? "w-full max-w-sm "
