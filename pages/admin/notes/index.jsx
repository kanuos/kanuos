...
const NotesModal = dynamic(() =>
  import("../../../components/admin/NotesModal").then((m) => m.NotesModal)
);
              ...
              {notes
                ...
                .map((n) => (
                  <li
                    key={n._id}
                    className={
                      "text-sm p-4 bg-light filter drop-shadow-xl rounded-md transition-all " +
                      (n.isComplete ? "opacity-50 hover:opacity-100" : "group")
                    }
                  >
