  ...
  try {
    ...
    switch (method.toLowerCase()) {
      ...
      case "patch":
        ...
        if (projectValidator.error)
          throw projectValidator.error.details[0].message;

        // try to update the project with sanitized data
        const updatedProject = await editIndividualProject(
          id,
          projectValidator.value,
          user._id
        );
