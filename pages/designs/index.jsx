...
const DesignList = ({ designList, totalCount }) => {
  ...
  return (
    ...
    >
      <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center gap-20 p-4 w-full mb-20 max-w-7xl mx-auto justify-center items-center">
        {count > 0 ? (
          <>
            {designList
              .filter((el) =>
